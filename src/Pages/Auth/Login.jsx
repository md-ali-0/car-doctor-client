        ...
        <div className="container mx-auto py-5 px-3">
            <div className="flex justify-evenly items-center gap-5">
                ...
                <div className="border rounded-xl p-5 w-1/2">
                    <h3 className='text-dark_02 text-4xl font-bold text-center'>Login</h3>
                    ...
                    <h4 className='text-dark_03 text-lg text-center'>Don&apos;t Have an account? <Link to='/register' className="text-primary font-bold">Sign Up</Link></h4>
                </div>
            </div>
        </div>
    );
